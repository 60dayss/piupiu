...
int main() {
    ...
    cout << "Результат первого упрощения = " << setw(4)<< upr1_1 << endl;

    double upr1_2 = x*upr1_1;
    cout <<"Результат второго упрощения = " << setw(4)<< upr1_2 << endl;

    double upr1_3 = upr1_2 + 32.76;
    cout << "Результат третьего упрощения = "<< setw(4) << upr1_3 <<endl;
    
    double finalrez1 = upr1_3 * x;
    cout << "Первый полином равен: "<< setw(4) << finalrez1;
    //Вычисляем второй полином

    double upr2_1 = -8980.032*(x*x)-186.34;
    cout << "\nРезультат первого упрощения = " << setw(4)<< upr2_1 << endl;
    double upr2_2 =(x*x)*upr2_1;
    cout << "Результат второго упрощения = " << setw(4)<< upr2_2 << endl;
    double upr2_3 =upr2_2-649.32;
    cout << "Результат третьего упрощения = "<< setw(4) << upr2_3 <<endl;

    double finalrez2 = (x*x)*upr2_3;
    cout << "Второй полином равен: "<< setw(4) << finalrez2;
    //Результат деления полиномов друг на друга

    cout <<"\nРезультатом деления полиномов друг на друга является: "<< setw(4) << finalrez1/finalrez2 ;
